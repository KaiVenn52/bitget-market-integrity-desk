  ...
  try {
    ...
    if (!stock) {
      ...
      const checks = [
        ...
        { id:'corporate', title:'Corporate actions', summary:'Dividend events and the earnings calendar, from the official Bitget MCP', ...mcp.corporateCheck, observations:[{label:'Source',value:mcp.integration.answered.includes('equity_fundamental_dividends') ? 'bitget-mcp-server' : 'Unavailable'},{label:'Policy',value:'Never infer absence from missing data'}]},
