...
|---|---:|---|
| Deterministic, decision, gate, study, routing and rate-limit unit tests | 225/225 passed, nine suites | Includes regressions for invalid quote/history values, MCP quote/history coherence, unusable dividend rows, out-of-window dividend history and missing earnings context. `npm.cmd test` |
