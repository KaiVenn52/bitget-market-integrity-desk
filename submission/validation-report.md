...
|---|---:|---|
| Deterministic, decision, checkpoint, gate, study, routing and rate-limit unit tests | 241/241 passed, eleven suites | Includes Stock+ ISO timestamp and embedded-session parsing, stale-reference Gate refusal and unknown alignment, MCP provenance checks, and nine browser-local checkpoint regressions. `npm.cmd test` |
