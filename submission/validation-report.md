...
|---|---:|---|
| Deterministic, decision, checkpoint, gate, study, routing and rate-limit unit tests | 231/231 passed, eleven suites | Includes Stock+ ISO timestamp and embedded-session parsing, stale-reference Gate refusal and unknown alignment, stateless MCP envelope and error propagation, and nine browser-local checkpoint regressions. `npm.cmd test` |
